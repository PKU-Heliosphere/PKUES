% 20-10-10 Modified by Die Duan, Xingyu Zhu, Jiansen He
% Based on the PDRK from Huasheng Xie

% =======================================================================
% Use this file to start run pkues.
...
tic; runtime=0;
disp('run ./input/pkues_setup.m .-.');
run ./input/pkues_setup;
runtime1=toc; runtime=runtime+runtime1;
disp([' use ',num2str(runtime1),' s, total ',num2str(runtime),'s']);
...
disp([' use ',num2str(runtime3),' s, total ',num2str(runtime),'s']);

tic;
% plot all the solutions
disp('run ./modules/pkues_plot_all.m ...');
run ./modules/pkues_plot_all;
runtime4=toc; runtime=runtime+runtime4;
disp([' use ',num2str(runtime4),' s, total ',num2str(runtime),'s']);
disp('---------------------------------------------------------------');
...
% disp([' use ',nudm2str(runtime5),' s, toal ',num2str(runtime),'s']);
% 
